...
pub const GridIntersection = struct {
    ...
    pub fn create(curve_index: u32, intersection: Intersection, grid_line: GridLine) @This() {
        return @This(){
...
pub fn RasterData(comptime T: type) type {
    ...
    return struct {
        ...
        pub fn openGridRecord(self: *@This()) !void {
            const grid_record = try self.subpath_records.addOne(self.allocator);
