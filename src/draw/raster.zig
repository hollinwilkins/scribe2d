...
const soup_estimate_module = @import("./estimate.zig");
const mem = std.mem;
...
pub const Rasterizer = struct {
    ...
    pub fn populateBoundaryFragments(self: @This(), soup: *Soup, path: *PathRecord) !void {
        _ = self;
    ...
    pub fn populateMergeFragments(self: @This(), soup: *Soup, path: *PathRecord) !void {
        {
    ...
    pub fn populateSpans(self: @This(), soup: *Soup, path: *PathRecord) !void {
        _ = self;
